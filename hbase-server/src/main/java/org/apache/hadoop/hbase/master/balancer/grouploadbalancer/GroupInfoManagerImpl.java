...
public class GroupInfoManagerImpl implements GroupInfoManager, ServerListener {
  ...
  /**
   * Gets the group info of a server. Returns null when a server has not been assigned to a group
   * yet. This is null check is used in other places to assign a server to a default group.
   *
  ...
  /**
   * Gets the group info of a table. Returns null when a table has not been assigned to a group
   * yet. This is null check is used in other places to assign a table to a default group.
   *
   * @param tableName gets the table name.
   * @return GroupInfo object of the group that the table belongs to
   * @throws IOException
   */
  @Override
  public GroupInfo getGroupOfTable(TableName tableName) {
